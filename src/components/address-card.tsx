        ...
        <div className="w-full h-20 p-3 flex flex-row items-center justify-between rounded-2xl border border-border">
            <div className="flex flex-row items-start justify-start gap-2">
                ...
                <div className="h-full flex flex-col gap-1 items-start justify-between">
                    <h1 className="text-xs font-semibold">{props.street}, {props.number}</h1>
                        ...
                        <DialogHeader>
                            ...
                            <form action={async (formData) => {
                                ...
                                <DialogFooter>
                                    ...
                                    <DialogClose asChild>
                                        <Button type="submit" className="bg-zinc-800 hover:bg-zinc-700 cursor-pointer">Salvar</Button>
                                    </DialogClose>
                                </DialogFooter>
                            </form>
                    </DialogContent>
